...
vqc = pure_VQC(img_size=args.resize_img).to(DEVICE)

# initialize optimizer
optimizer = torch.optim.Adam(vqc.parameters(), lr=args.lr)
...
experiment_name = f"pure_VQC_{n_qubits}qubits_depth{args.vqc_depth}_lr{args.lr:.0e}_{args.epochs}epochs_{timestamp}"
