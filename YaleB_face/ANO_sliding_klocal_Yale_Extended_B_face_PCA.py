...
experiment_name = f"ANO_sliding_{args.k_local}local_YaleFace_PCA{n_qubits}d_depth{args.vqc_depth}_lr{args.lr:.0e}_lrH{args.lr_H:.0e}_{args.epochs}epochs_{timestamp}"
